...
class IniciarSolicitacaoState extends State<IniciarSolicitacao> {
  ...
  void _fechTipoSolicitacao() async {
    var res = await http.get(
        'https://www.accio.com.br:447/api/v1/tiposSolicitacoes?access_token=' + token.access_token.toString());
    if(mounted){
      this.setState(() {
        ...
        body: Stack(
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text(
                  'Para enviar a documentação, consulte antes no menu as regras para opção desejada.',
